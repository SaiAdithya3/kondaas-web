...
import bgcover from "../assets/image.png";
      ...
      <div className="w-full flex items-center justify-center py-8">
        <div className="w-[95%] relative">
          <div className="h-screen w-full">
            <img
              src={isNight && isNight ? night && night : day && day}
              alt="bgcover"
          ...
          <div className="w-1/4 flex gap-5 flex-col bg-zinc-400/40 border-zinc-300/50 border rounded-2xl py-10 p-6 right-5 bottom-5 backdrop-blur-md absolute">
            {/* Toggle Button */}
            <label className="theme-switch">
              ...
              />
              <div
                className={`theme-switch__container ${isNight ? "night" : ""}`}
              >
            ...
            {/* Heading Text */}
            <h1 className="text-4xl text-white ml-4">
              South India's Premier On-Grid Solar Installer
            </h1>
          </div>
        </div>
      </div>
